    ...
    <div name='home' className='w-full h-screen bg-slate-900'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            <div className='flex justify-end pt-[100px]'>
                <img className='rounded-full max-w-[200px] m-8' src={profilePic} alt="" />
            </div>
            ...
            <p className='text-gray-400 py-4 max-w-[700px]'>I’m a full-stack developer with a knack for design and a thirst for knowledge. I have a passion for code and an eye for design. I love to make software that is not only functional and efficient but also beautiful.</p>
            ...
            <div>
                ...
                <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-blue-200'>
